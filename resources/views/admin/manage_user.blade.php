                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, atau hapus akun serta data mahasiswa </p> <hr>
                                <a href="/admin/manajemen_mhs" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, dan hapus akun serta data dosen </p> <hr>
                                <a href="/admin/manajemen dosen" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, dan hapus akun serta data admin </p> <hr>
                                <a href="/admin/manajemen_admin" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, dan hapus akun serta data prodi </p> <hr>
                                <a href="/admin/manajemen_prodi" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
