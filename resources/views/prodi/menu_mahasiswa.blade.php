                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <a href="/prodi/menu_mahasiswa/mahasiswa_aktif" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Daftar mahasiswa alumni, judul skripsi, dan dosen pembimbing. </p> <hr>
                                <a href="/prodi/menu_mahasiswa/mahasiswa_alumni" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
