                                    ...
                                    <form class="form form-horizontal" method="post" action="{{route('store_dosbing')}}">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control  @error('dosbing1') is-invalid @enderror" id="dosbing1" name="dosbing1" required value="{{ old('dosbing1') }}" autocomplete="dosbing1">
                                                        <option value=""></option>
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control  @error('dosbing2') is-invalid @enderror" id="dosbing2" name="dosbing2" required value="{{ old('dosbing2') }}" autocomplete="dosbing2">
                                                        <option value=""></option>
                                                        @foreach($dosens as $dosen)
                                                            <option  value="{{$dosen->nip}}">{{$dosen->nama}} - {{$dosen->nip}}</option>
                                                        @endforeach
