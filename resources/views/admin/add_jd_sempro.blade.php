...
@section('title')
    <title>Admin - Penjadwalan Sempro</title>
@endsection
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Daftar Jadwal Sempro</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card col-xl-12 card-outline-secondary">
                    ...
                    <div class="row align-items-center m-5">
                        <div class="col-xl-12 mb-5">
                            ...
                            <form class="form form-horizontal" method="post" action="{{route('store_jd_sempro')}}">
                                @csrf
