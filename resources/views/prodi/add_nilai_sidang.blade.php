...
@section('title')
    <title>Prodi - Data Nilai Sidang Meja Hijau</title>
@endsection
                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-5">    
                            ...
                            <form class="form form-horizontal" action="{{route('store_nilai_sidang')}}" method="POST">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="text" id="n17" class="form-control  @error('n17') is-invalid @enderror" name="n17" required autocomplete="n17">
                                            @error('n17')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="text" id="n18" class="form-control  @error('n18') is-invalid @enderror" name="n18" required autocomplete="n18">
                                            @error('n18')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="text" id="n19" class="form-control  @error('n19') is-invalid @enderror" name="n19" required autocomplete="n19">
                                            @error('n19')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="text" id="n20" class="form-control  @error('n20') is-invalid @enderror" name="n20" required autocomplete="n20">
                                            @error('n20')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
