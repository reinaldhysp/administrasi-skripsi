            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('prasemhas_menu')}}">Pra Seminar Hasil</a></li>
                            <li class="breadcrumb-item"><a href="{{route('daftar_dosenPenguji')}}">Dosen Penguji</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Dosen Penguji</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card card-outline-secondary">
                            ...
                            <div class="row align-items-center m-5">
                                <div class="col-md mb-5">    
                                    <!-- FORM EDIT DOSBING -->
                                    <form class="form form-horizontal" method="post" action="{{route('store_new_dosen_penguji')}}">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="nama" class="form-control" name="nama" value="{{$nama}}" disabled>
                                                    @error('nama')
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="nim" class="form-control" name="nim" value="{{$nim}}" disabled>
                                                    @error('nim')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control  @error('dosen_penguji1') is-invalid @enderror" id="dosen_penguji1" name="dosen_penguji1" required value="{{ old('dosen_penguji1') }}" autocomplete="dosen_penguji1">
                                                        <option value="{{$dosen_penguji1->nip}}"> {{$dosen_penguji1->nama}} - {{$dosen_penguji1->nip}}</option>
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control  @error('dosen_penguji2') is-invalid @enderror" id="dosen_penguji2" name="dosen_penguji2" required value="{{ old('dosen_penguji2') }}" autocomplete="dosen_penguji2">
                                                        <option value="{{$dosen_penguji2->nip}}">{{$dosen_penguji2->nama}} - {{$dosen_penguji2->nip}}</option>
                                                        @foreach($dosens as $dosen)
                                                            <option  value="{{$dosen->nip}}">{{$dosen->nama}} - {{$dosen->nip}}</option>
                                                        @endforeach
                                                    </select>
