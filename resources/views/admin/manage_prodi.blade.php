...
@section('title')
    <title>Admin - Manajemen Prodi</title>
@endsection
                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-6">            
                            <h5>Daftar Akun dan Data Prodi</h5></br>
                                <a href="/admin/add_prodi" class="btn btn-success btn-sm"><i class="bi bi-plus-circle"></i>&nbsp;&nbsp;Daftar baru</a>
                            <br><br>
                                                        ...
                                                        <tr>
                                                            <td>                                                       
                                                                <form action="/admin/edit_prodi" >
                                                                    @csrf
                                                                    <input type= "hidden" name= "nip" value= "{{$prodi->nip}}">
                                                                    <button type="submit" class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i>&nbsp;&nbsp;Edit</button>
                                                                </form>
                                                            </td>
                                                            <td>
                                                                <form action="{{'/admin/delete_prodi'}}" method="POST">
                                                                    @csrf
                                                                    <input type="hidden" name="nip" value="{{$prodi->nip}}">
                                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data prodi ini? Anda tidak akan dapat mengembalikan data yang telah dihapus.')"><i class="bi bi-trash"></i>&nbsp;&nbsp;Hapus</button>
                                                                </form>
                                                            </td>
                                                        </tr>
                                                    </table>
