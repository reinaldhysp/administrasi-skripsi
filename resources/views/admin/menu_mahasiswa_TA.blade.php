                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <a href="{{route('aktif')}}" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <a href="{{route('alumni')}}" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
