                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Penghapusan Skripsi</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row align-items-center m-5">
                        <div class="col-xl-12 mb-6">    
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p> Melakukan penghapusan judul skripsi pada tanggal {{$result->created_at}} mahasiswa dengan NIM <b>{{$result->nim}}</b>. Data yang tersimpan sebelum dihapus sebagai berikut. <br>
                            ...
                            <div class="d-felx justify-content-center">
                                <a href="{{route('log_penghapusan_skripsi')}}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>
                            </div>                      
                        </div>
                    </div>
                </div>
