                ...
                <div class="col-xl-4 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Daftar Dosbing</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, dosen pembimbing untuk mahasiswa tingkat akhir.</p> <hr>
                                <a href="{{route('daftar_dosbing')}}" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Semua berkas administrasi sebelum seminar proposal dapat diakses di menu ini.  </p> <hr>
                                <a href="/admin/validasi_sempro" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
