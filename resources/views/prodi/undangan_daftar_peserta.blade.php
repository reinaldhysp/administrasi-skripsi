                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content">
                                        <a href="/prodi/undangan_daftar_peserta/seminar_proposal" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Akses </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content">
                                        <a href="/prodi/undangan_daftar_peserta/seminar_hasil" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Akses </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content">
                                        <a href="/prodi/undangan_daftar_peserta/sidang_meja_hijau" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Akses </a>
                                    </div>
                                </div>
                            </div>
                        </div>
