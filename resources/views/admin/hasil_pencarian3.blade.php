                    ...
                    <div class="row align-items-center m-5">
                        <div class="col-xl-12 mb-6">    
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody class="text-justify">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    Admin <i>{{$result->nama_admin}}</i>  mengubah dosen pembimbing untuk mahasiswa pada {{$result->created_at}} atas nama:<br>
                                                    Nama / NIM : <i>{{$result->nama}} {{$result->nim}}</i><br>
                                                    dengan perubahan NIP dosbing sebagai berikut. <br>
                                                    NIP Dosbing 1 : {{$result->old_nip_dosbing1}}  <b>menjadi</b> {{$result->new_nip_dosbing1}}<br>
                                                    NIP Dosbing 2 : {{$result->old_nip_dosbing2}}  <b>menjadi</b> {{$result->new_nip_dosbing2}}<br>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                            @endforeach
                            ...
                            <div class="d-felx justify-content-center">
                                <a href="{{route('log_pendaftaran_dosbing')}}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>
                            </div>                        
                        </div>
                    </div>
                </div>
