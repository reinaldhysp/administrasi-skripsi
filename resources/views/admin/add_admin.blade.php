                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/admin/manajemen_admin">Admin</a></li>
                            ...
                            <form class="form form-horizontal" action="{{route('add_admin')}}" method="POST">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <!-- DATA AKUN -->
                                        <h3>1. Data Akun Administrator</h3> <br><br>
                                        <div class="col-md-4">
                                        ...
                                        <!-- DATA PRIBADI ADMIN -->
                                        <h3>2. Data Pribadi Admin</h3> <br><br>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control  @error('status') is-invalid @enderror" id="sex" name="status" required value="{{ old('status') }}" autocomplete="status">
                                                <option value=""></option>
