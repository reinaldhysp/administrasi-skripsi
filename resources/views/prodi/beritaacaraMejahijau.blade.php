...
@section('title')
    <title>Prodi - Berita Acara Sidang Meja Hijau</title>
@endsection
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Berita Acara Meja Hijau</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-bordered mb-0 text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/prodi/beritaacara/mejahijau/{{$query[$i]->nim}}"><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-printer"></i>&nbsp;&nbsp;Meja Hijau</button></a>
                                                        </td>
                                                    </tr>   
                                                    @endfor
                                                </tbody>
