                            ...
                            <form class="form form-horizontal" action="{{route('storeSkripsi')}}" method="POST">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="eng_judul_skripsi" class="form-control  @error('eng_judul_skripsi') is-invalid @enderror" value="{{ old('eng_judul_skripsi') }}" name="eng_judul_skripsi" autocomplete="eng_judul_skripsi">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <select id="bid_tulis" class="form-control  @error('bid_tulis') is-invalid @enderror" value="{{ old('bid_tulis') }}" name="bid_tulis" autocomplete="bid_tulis">
