                        ...
                        <div class="card card-outline-secondary">
                            ...
                            <div class="row align-items-center m-5">
                                <div class="col-md mb-5">    
                                    <!-- FORM EDIT DOSBING -->
                                    <form class="form form-horizontal" method="post" action="{{route('store_new_dosbing')}}">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control  @error('new_dosbing1') is-invalid @enderror" id="new_dosbing1" name="new_dosbing1" required value="{{ old('new_dosbing1') }}" autocomplete="new_dosbing1">
                                                        <option value="{{$dosbing1->nip}}"> {{$dosbing1->nama}} - {{$dosbing1->nip}}</option>
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control  @error('new_dosbing2') is-invalid @enderror" id="new_dosbing2" name="new_dosbing2" required value="{{ old('new_dosbing2') }}" autocomplete="new_dosbing2">
                                                        <option value="{{$dosbing2->nip}}">{{$dosbing2->nama}} - {{$dosbing2->nip}}</option>
                                                        @foreach($dosens as $dosen)
                                                            <option  value="{{$dosen->nip}}">{{$dosen->nama}} - {{$dosen->nip}}</option>
                                                        @endforeach
                                                    </select>
