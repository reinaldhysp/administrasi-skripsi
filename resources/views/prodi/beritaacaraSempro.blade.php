...
@section('title')
    <title>Prodi - Berita Acara Seminar Proposal</title>
@endsection
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                <p class="text-subtitle text-muted">Daftar berita acara seminar proposal</p>
                            </div>
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/prodi/beritaacara">Berita Acara</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Berita Acara Sempro</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="card card-outline-secondary">
                                <div class="row align-items-center m-5">
                                   <div class="col-md mb-6">
                                        <h5>Berita Acara Seminar Proposal</h5><br>
                                            ...
                                            <table class="table table-bordered mb-0 text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/prodi/beritaacara/sempro/{{$query[$i]->nim}}"><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-printer"></i>&nbsp;&nbsp;Cetak</button></a>
                                                        </td>
                                                    </tr>   
                                                    @endfor
                                                </tbody>
