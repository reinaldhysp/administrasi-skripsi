                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, dan hapus jadwal seminar proposal</p> <hr>
                                <a href="{{route('jadwal_sempro')}}" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, dan hapus jadwal seminar </p> <hr>
                                <a href="{{route('jadwal_semhas')}}" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p>Tambahkan, edit, dan hapus jadwal sidang </p> <hr>
                                <a href="{{route('jadwal_sidang')}}" class="btn btn-primary"><i class="bi bi-hand-index"></i> Access</a>
                            </div>
                        </div>
                    </div>
                </div>
