                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <table>
                                                    ...
                                                    @if($mhs->total != NULL)
                                                        <td>
                                                            <form action="{{route('adm_edit_nilai_uji_program')}}">
                                                                @csrf
                                                        ...
                                                        <td>
                                                            <form action="{{route('adm_delete_nilai_uji_program')}}" method="POST">
                                                                @csrf
                                                                <input type="hidden" name="nim" value="{{$mhs->nim}}">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <form action="{{route('adm_add_nilai_uji_program')}}" method="GET">
                                                                @csrf
                                                                <input type= "hidden" name= "nim" value= "{{$mhs->nim}}">
