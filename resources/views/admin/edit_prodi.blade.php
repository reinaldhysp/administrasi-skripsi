                                            ...
                                            <div class="col-xl-12 col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{$prodi->nama}}">
                                                        @error('nama')
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="new_nip" class="form-control @error('new_nip') is-invalid @enderror" name="new_nip" value="{{$prodi->nip}}">
                                                        @error('new_nip')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="new_nidn" class="form-control @error('new_nidn') is-invalid @enderror" name="new_nidn" value="{{$prodi->nidn}}">
                                                        @error('new_nidn')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="new_kode" class="form-control @error('new_kode') is-invalid @enderror" name="new_kode" value="{{$prodi->kode}}">
                                                        @error('new_kode')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
