			...
			<div>
				<center>
					...
					<div>
						<table width="625">
							<tr>
								<td class="text3" colspan="2"><font size="3"><b>FORM CALON PEMBIMBING</b></font></td>
								<td width="100" class="skrtt" rowspan="4">Foto Terbaru</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="280" style="padding-left: 7px;" class="ayyo">: {{Auth::user()->mhs->nim}}</td>
							</tr>
						</table><br>
					</div>
					...
					<div>
						<table width="625">
							...
							<tr>
								<td width="170" class="mun"><font size="1"><i>(Kosongkan nama calon dosen pembiming, akan dibahas pada rapat bersama 
									Dosen Program Studi Teknologi Informasi)</i></font></td>
								<td width="50"></td>
							</tr>
						</table><br>
						<table width="625">
