...
@section('title')
    <title>Prodi - Data Nilai Uji Program</title>
@endsection
                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-5">    
                            ...
                            <form class="form form-horizontal" action="{{route('store_nilai_program')}}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <input type="text" id="n6" class="form-control  @error('n6') is-invalid @enderror" name="n6" required autocomplete="n6">
                                            @error('n6')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
