                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/prodi/mahasiswa">Mahasiswa TA</a></li>
                                            ...
                                            <table class="table table-bordered mb-0 text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/prodi/mahasiswa/{{$query[$i]->nim}}"><button class="btn btn-primary btn-sm"><i class="bi bi-eye"></i>&nbsp;&nbsp;Selengkapnya</button></a>
                                                        </td>
                                                    </tr>   
                                                    @endfor
                                                </tbody>
