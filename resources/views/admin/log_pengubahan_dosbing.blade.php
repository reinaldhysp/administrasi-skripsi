        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Sama seperti pendaftaran, pengeditan dosbing juga hanya dilakukan oleh admin!</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('log_aktivitas')}}">Riwayat Aktivitas</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Pengubahan Dosbing</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <table class="table table-bordered mb-0 text-justify">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Admin {{$log->nama_admin}} mengubah dosen pembimbing untuk mahasiswa bernama <b>{{$log->nama}}</b>, NIM <b>{{$log->nim}}</b>, 
                                                menjadi seperti berikut berikut. <br>
                                                NIP Dosbing 1 : {{$log->old_nip_dosbing1}}  <b>menjadi</b> {{$log->new_nip_dosbing1}}<br>
                                                NIP Dosbing 2 : {{$log->old_nip_dosbing2}}  <b>menjadi</b> {{$log->new_nip_dosbing2}}<br>
                                            </td>
