                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-6">    
                            ...
                            <a href="/admin/add_mhs" class="btn btn-success btn-sm "><i class="bi bi-plus-circle"></i>&nbsp;&nbsp;Tambah Mahasiswa</a>
                            <br><br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{'/admin/delete_mhs'}}" method="POST">
                                                                ...
                                                                <input type="hidden" name="nim" value="{{$mahasiswa->nim}}">
                                                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data mahasiswa ini? Anda tidak akan dapat mengembalikan data yang telah dihapus.')"><i class="bi bi-trash"></i>&nbsp;&nbsp;Hapus</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                </table>
