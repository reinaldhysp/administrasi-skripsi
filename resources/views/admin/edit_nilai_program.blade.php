...
@section('title')
    <title>Admin - Edit Nilai Uji Program</title>
@endsection
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('adm_nilai_uji_program')}}">Input Nilai Uji Program</a></li>
                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-5">    
                            ...
                            <form class="form form-horizontal" action="{{route('adm_store_upd_nilai_program')}}" method="POST">
                                @csrf
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" required value="{{$data->tanggal}}">
                                            @error('tanggal')
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="time" class="form-control @error('waktu') is-invalid @enderror" id="waktu" name="waktu" required value="{{$data->waktu}}">
                                            @error('waktu')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="n1" class="form-control  @error('n1') is-invalid @enderror" name="n1" value="{{$data->n1}}" autocomplete="n1">
                                            @error('n1')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="n2" class="form-control  @error('n2') is-invalid @enderror" name="n2" value="{{$data->n2}}" autocomplete="n2">
                                            @error('n2')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="n3" class="form-control  @error('n3') is-invalid @enderror" name="n3" value="{{$data->n3}}">
                                            @error('n3')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="n4" class="form-control  @error('n4') is-invalid @enderror" name="n4" value="{{$data->n4}}">
                                            @error('n4')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="n5" class="form-control  @error('n5') is-invalid @enderror" name="n5" value="{{$data->n5}}">
                                            @error('n5')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="n6" class="form-control  @error('n6') is-invalid @enderror" name="n6" value="{{$data->n6}}" required>
                                            @error('n6')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control  @error('nip') is-invalid @enderror" id="nip" name="nip" required autocomplete="nip">
