...
@section('title')
    <title>Admin - Profile Saya</title>
@endsection
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('profile_admin')}}">Profile Saya</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card card-outline-secondary">
                            ...
                            <div class="row align-items-center m-5">
                                <div class="col-md mb-5">    
                                    <!-- FORM EDIT PROFILE -->
                                    <form class="form form-horizontal" method="post" action="{{route('store_new_admin')}}">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="nama" class="form-control" name="nama" value="{{Auth::user()->admin->nama}}">
                                                    @error('nama')
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="email" id="new_email" class="form-control" name="new_email" value="{{Auth::user()->email}}">
                                                    @error('new_email')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <center>
                                                    <table>
                                                        <table>
                                                            <td>
                                                                <a href="/admin/dashboard" class="btn btn-success"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>    
                                                            </td>
                                                            <td>
                                                                <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;Simpan Perubahan</button><br>
                                                            </td>
                                                        </table>
                                                    </table>
                                                </center>
