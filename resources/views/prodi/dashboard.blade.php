                                    ...
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <a href="/prodi/menu_mahasiswa" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Akses</a>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <a href="/prodi/beritaacara" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Akses</a>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <a href="/prodi/undangan_daftar_peserta" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Akses</a>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    Input nilai IPK, input nilai seminar proposal, input nilai seminar hasil, input nilai sidang meja hijau.
                                                </p>
                                                <a href="/prodi/input_nilai" class="btn btn-primary btn-sm"><i class="bi bi-check-circle"></i> Akses</a>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
